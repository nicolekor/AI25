...
GATE_MIN  = float(os.getenv("GATE_MIN",  "0.70"))  # 정답 채택 최소 신뢰도 기준 = 70%
DELTA_MAX = float(os.getenv("DELTA_MAX", "0.45"))  # 둘 모델간의 신뢰도 격차 허용 범위 = 45% 
AGREE_MIN = float(os.getenv("AGREE_MIN", "0.60"))  # 합의 예외 허들 : 두 모델 모두 60% 이상일 경우 정답 채택
